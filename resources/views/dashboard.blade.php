            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main>
                    ...
                    <div
                        ...
                        <h1 class="text-2xl font-semibold">لوحه التحكم</h1>
                    ...
                    <div class="mt-2">
                        ...
                        <div>
                            <!-- main content in the body -->
                            <a href="{{ route('articles.create') }}" class="btn btn-primary px-5 mx-3">اضف مقال</a>
...
<td style="width: 300px; max-height: 200px; overflow: hidden;">
    ...
    <a class="btn btn-primary" href="#" id="read-more">Read More</a>
                ...
                <footer
                    ...
                    <div>شركه دروب الاعلاميه &copy; 2023</div>
                    <div>
                        Made by
                        <a href="#" target="_blank" class="text-blue-500 hover:underline">Ahmed khatatbeh</a>
                    </div>
                </footer>
            </div>
