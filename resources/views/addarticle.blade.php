...
<body>
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <main class="col-12">
                    ...
                    <div
                        ...
                        <h1 class="text-2xl font-semibold"> اضف مقال</h1>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="title" name="title" placeholder="أدخل عنوان المقال">
    </div>

    <div class="mb-3">
        <label for="description" class="form-label">وصف المقال:</label>
        <input type="text" class="form-control" id="description" name="description" placeholder="أدخل وصف المقال">
    </div>
    ...
    <div class="mb-3">
        <button type="submit" class="btn btn-primary px-5 form-control">أضف</button>
    </div>
</form>
