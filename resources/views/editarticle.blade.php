...
<head>
    ...
    <link rel="stylesheet" href="{{url('build/css/tailwind.css')}}" />
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" x-ref="userMenu"
                                   ...
                                   <form action="{{ route('logout') }}" method="post">
                                        @csrf
                                        <button
                                            class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary"type="submit">
                                            تسجيل الخروج
                ...
                <main class="col-12">
                    ...
                    <div
                        ...
                        <h1 class="text-2xl font-semibold"> تعديل المقال</h1>
                    ...
                    <div class="mt-2 ">
                        <!-- State cards -->
                           ...
                           <form method="POST"  action="{{route('articles.update',$article->id)}}">
                            ...
                            @method('patch')
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label ">:عنوان المقال</label>
    <input type="text" class="form-control" name="title" value="{{$article->title}}">
    
  </div>
  <div class="mb-3">
    
    <label for="exampleInputEmail1" class="form-label"> :وصف المقال</label><br>
    
    <textarea  name="description"  id="textArea" cols="150" rows="10" >
{{$article->description}}
    </textarea>
  ...
  <div class="mb-3">
  <label for="formFileMultiple" class="form-label">:اضف صوره</label>
  <input class="form-control" type="file" id="formFileMultiple" value="{{$article->image}}" >
</div>
  <div class="mb-3">
  <button type="submit" class="btn btn-primary px-5  form-control">تحديث</button>
</div>
</form>
...
function getText() {
  ...
  // Display the text in an alert (you can modify this part as needed)
}
